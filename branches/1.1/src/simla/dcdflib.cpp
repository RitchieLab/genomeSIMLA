...
#define FEQRANGE 0.00001
#define FEQUIV(A, B) A > B - FEQRANGE && A < B + FEQRANGE
#define NFEQUIV(A, B) !(A > B - FEQRANGE && A < B + FEQRANGE)
...
S140:
    if(ext == 3) p *= 2.0e0;
    if(!(FEQUIV(p*1.0e0, 0.0e0) || p <= q*tol)) goto S150;
    w = tol;
    goto S180;
S150:
    if(!(p < mb*q)) goto S160;
...
*/
    ...
    *ierr = 0;
    if(FEQUIV(*p, 0.0e0)) return;
    if(FEQUIV(*q, 0.0e0)) goto S270;
    if(FEQUIV(*a, 1.0e0)) goto S280;
    e2 = 2.0e0*e;
    amax = 0.4e-10/(e*e);
    iop = 1;
    if(e > 1.e-10) iop = 2;
...
S190:
    ...
    *ierr += 1;
    ...
    if(FEQUIV(pn, 0.0e0) || FEQUIV(qn, 0.0e0)) goto S350;
    r = rcomp(a,&xn);
    if(FEQUIV(r,  0.0e0)) goto S350;
    t = (pn-*p)/r;
    w = 0.5e0*(am1-xn);
...
S60:
    x += (0.5e0+0.5e0);
    t = x*t;
    if(FEQUIV(t, 0.0e0)) return Xgamm;
S70:
/*
...
*/
    ...
    s = sin(pi*t)/pi;
    if(fifmod(n,2) == 0) s = -s;
    if(FEQUIV(s, 0.0e0)) return Xgamm;
S120:
/*
...
-----------------------------------------------------------------------
*/
    if(FEQUIV(*a**x, 0.0e0)) goto S120;
    if(FEQUIV(*a, 0.5e0)) goto S100;
    if(*x < 1.1e0) goto S10;
    goto S60;
S10:
/*
...
*/
    ...
    if((FEQUIV(*a, 0.0e0)) && (FEQUIV(*x, 0.0e0))) goto S430;
    if(FEQUIV(*a**x,  0.0e0)) goto S420;
    iop = *ind+1;
...
*/
    if(*a >= 1.0e0) goto S10;
    if(FEQUIV(*a, 0.5e0)) goto S390;
    if(*x < 1.1e0) goto S160;
    t1 = *a*log(*x)-*x;
    u = *a*exp(t1);
    if(FEQUIV(u, 0.0e0)) goto S380;
    r = u*(1.0e0+gam1(a));
    goto S250;
S10:
    ...
    twoa = *a+*a;
    m = fifidint(twoa);
    if(!FEQUIV(twoa, (double)m)) goto S20;
    i = m/2;
    if(FEQUIV(*a, (double)i)) goto S210;
    goto S220;
S20:
    t1 = *a*log(*x)-*x;
    r = exp(t1)/Xgamm(a);
...
S20:
    u = *x/ *a;
    if(FEQUIV(u, 0.0e0)) return rcomp;
    t = pow(1.0e0/ *a,2.0);
    t1 = (((0.75e0*t-1.0e0)*t+3.5e0)*t-105.0e0)/(*a*1260.0e0);
    t1 -= (*a*rlog(&u));
