...
public:
    ...
    ModelStatistics() : foldCount(0), winnerFrequency(0), sumTestingStatistic(0.0), sumTrainingStatistic(0.0), sumPredError(0.0), sumClassError(0.0), sumMOR(0.0), xvConst(0), testingCount(0), predCount(0), clsCount(0), orCount(0), trainingCount(0) {}
    ~ModelStatistics() {}
