...
const string DEFAULT_VERBOSE = "OFF", DEFAULT_USETABLEVAR= "ON", DEFAULT_SUBMODELS = "OFF";
...
//	void AppendFrequencies(float freq1, float freq2);
	 ...
	 */
	void AddDiseaseLocus(int chr, int idx, float fr1, float fr2);

	void AddDiseaseLocus(DiseaseLocus &l);

	/**
	 * @brief Return a locus from the current model
	 */
	DiseaseLocus &GetDiseaseLocus(int idx);
  ...
  private:
    ...
    static double const DEFAULT_FREQ_HIGH = 0.8;
    static double const DEFAULT_FREQ_LOW = 0.2;
    static double const DEFAULT_HERIT = 0.0;
    ...
    double static const DEFAULT_MARG = 0.00001;
    double static const DEFAULT_TABLE = 0.1;
    double static const DEFAULT_MUTATION = 0.001;
    double static const DEFAULT_CROSSOVER = 0.9;
    double static const DEFAULT_TARGETPEN = 0.0;
    int static const DEFAULT_MARGWEIGHT = 5;
    int static const DEFAULT_HERITWEIGHT = 5;
    double static const DEFAULT_ODDS_RATIO = 0;
    double static const DEFAULT_ODDS_WEIGHT = 0.05;
    ...
    double static const DEFAULT_MINSNP = 5;
    double static const DEFAULT_MAXSNP = 5;
    double static const DEFAULT_MINRECOMB = 0.005;
    double static const DEFAULT_MAXRECOMB = 0.05;
