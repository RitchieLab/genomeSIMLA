...
public:
	 ...
	 */
	SnpEvalSuite(SnpEvaluation *training, PTestDistribution *fDist, PTestDistribution *orDist = NULL);
...
inline
SnpEvalSuite::SnpEvalSuite(SnpEvaluation *training, PTestDistribution *fDist, PTestDistribution *orDist) : trainingSuite(training), fitnessDist(fDist), orDist(orDist) {
	training->SetFitnessDist( fDist );
	training->SetOddsRatioDist( orDist);
}

inline
SnpEvalSuite::SnpEvalSuite() : trainingSuite(NULL), fitnessDist(NULL), orDist(NULL) {
}
