...
inline
FamilyMember::FamilyMember(const char *famID, const char *id) : father(NULL), mother(NULL), famID(famID), id(id), affectedStatus(0), genotypedata(NULL), markForDeletion(true) {}

inline
FamilyMember::FamilyMember(FamilyMember *father, FamilyMember *mother, const char *famID, const char *id) : father(father), mother(mother), famID(famID), id(id), affectedStatus(0), genotypedata(NULL), markForDeletion(true) {}
