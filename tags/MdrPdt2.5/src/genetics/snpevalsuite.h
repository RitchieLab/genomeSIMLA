...
public:
	 ...
	 */
	SnpEvalSuite(SnpEvaluation *training, PTestDistribution *fDist, PTestDistribution *orDist = NULL, PTestDistribution *peDist = NULL);
...
inline
SnpEvalSuite::SnpEvalSuite(SnpEvaluation *training, PTestDistribution *fDist, PTestDistribution *orDist, PTestDistribution *peDist) : trainingSuite(training), fitnessDist(fDist), orDist(orDist), peDist(peDist) {
...
inline
SnpEvalSuite::SnpEvalSuite() : trainingSuite(NULL), fitnessDist(NULL), orDist(NULL), peDist(NULL) {
}
