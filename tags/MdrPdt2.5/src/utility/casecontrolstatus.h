...
struct CaseControlStatus{
	...
	uint affectedWeight;				///<Used to keep track of the weights to be used in the calculations
	uint unaffectedWeight;				///<Used to keep track of the weights to be used in the calculations
	uint affectedCount;					///<Cash the counts in case we just need them
	uint unaffectedCount;				///<Cash the counts in case we just need them
	uint totalCount;					///<Cash the counts 
