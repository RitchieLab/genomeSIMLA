...
protected:
	...
	void SaveResults(uint nID, const char *filename, uint position, vector<ModelStatistics> &stats);
	/**
	 ...
	 */
	double PedigreeSearch(const char *filename, int seed, uint testID);
