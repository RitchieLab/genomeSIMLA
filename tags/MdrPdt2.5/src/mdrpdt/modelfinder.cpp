...
struct threadArgs {
	...
	threadArgs(ModelFinder *main, PTestDistribution *fDist, PTestDistribution *oDist, PTestDistribution *pDist) 
			: main(main), fDist(fDist), oDist(oDist), pDist(pDist) {}
};
...
void *ModelFinder::ProcessWatcher(void *arg) {
	...
	PTestDistribution *pDist = ((threadArgs*)arg)->pDist;
...
//Here, we don't need to do this unless we are using MPI
	...
	threadArgs args(this, fDist, oDist, pDist);	
